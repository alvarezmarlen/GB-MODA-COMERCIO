    ...
    <div v-if="editingStory" class="modal-overlay" @click.self="cancelEdit">
      <div class="modal-content">
        ...
        <div class="modal-fields">
          ...
          <div class="modal-field">
            <label class="custom-label">País de origen</label>
...
.admin-card-image-box { width:120px; height:120px; background:var(--wf-button-bg); display:flex; justify-content:center; align-items:center; font-weight:bold; border:1px solid var(--color-primary); flex-shrink:0; text-transform:uppercase; letter-spacing:1px; font-size:0.8rem; }
